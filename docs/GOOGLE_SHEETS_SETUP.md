...
3. Replace the default script with the contents of [`GOOGLE_APPS_SCRIPT.gs`](../scripts/google/GOOGLE_APPS_SCRIPT.gs).
4. Save the project.
...
Open [`assets/js/script.js`](../assets/js/script.js) and replace this value:

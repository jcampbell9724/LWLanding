...
2. Copy the format from `blog-posts/POST_TEMPLATE.md`.
...
- reads all `.md` files in `blog-posts/`
- generates `blog/index.html`
- generates one static HTML page per post in `blog/`

## Notes

- The blog is static. New posts do not appear until you rerun `python generate_blog.py`.
